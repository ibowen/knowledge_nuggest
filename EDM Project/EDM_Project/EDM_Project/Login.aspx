<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="EDM_Project.Login" %>
    ...
    <div>
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="Red" Text="Username or Password cannot be empty!!" Visible="False"></asp:Label>
                </td>
                <td>&nbsp;</td>
            </tr>
